...
class perform:
    ...
    def set__StockHistoryDataframe(self,_StockHistoryDataframe):
        self.__StockHistoryDataframe = _StockHistoryDataframe
    def get__StockHistoryDataframe(self):
        return self.__StockHistoryDataframe
    _StockHistoryDataframe = property(get__StockHistoryDataframe, set__StockHistoryDataframe)
...
#    DailyReturnsDataframe = property(get_DailyReturnsDataframe, set_DailyReturnsDataframe)
    ...
    def __init__(self
        ...
        self.PriceHistoryDataframe = self.monthlystockhistory()
...
#        startdate_string = self.StartDateString
        ...
        import numpy as np
        df_monthlypricesfinite = df_monthlyprices[np.isfinite(df_monthlyprices['e_adjclose'])]
        ...
        df_monthlypricestotoday = df_monthlypricesfinite.append(df_curr, ignore_index=True)

        return df_monthlypricestotoday
...
if __name__=='__main__':
    ...
    o = perform(symbol=symbol,startdate_string=startdate,period='monthly')

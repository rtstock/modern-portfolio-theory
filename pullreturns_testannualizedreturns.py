...
#        if backfillweekends == True:
#            self.MonthlyReturnsDataframe = self._monthlyreturnsusingyahoosymbol()
#            self.DailyReturnsDataframe = self._dailyreturnsusingyahoosymbol_backfilled()
#        else:
#            self.MonthlyReturnsDataframe = self._monthlyreturnsusingyahoosymbol()
#            self.DailyReturnsDataframe = self._dailyreturnsusingyahoosymbol_notbackfilled()
...
#        df_00 = pp.stockhistorybackfilledtodatframeofstockhistoryinstancesusingcache(symbol,startdate_string,str(yesterday_date)) #,str(today_date))
    ...
    def dailyreturns(self,):
        ...
        rows_dailyreturns = []        
        #rows_optionpricescurrent.append(['optionsymbol','stockprice','strike','pdeltapct_to_sell_price','cumprob_to_sell_price','bid','ask','last'])
        rows_dailyreturns.append(['a_symbol','b_monthend','e_pctchange','d_end'])
        ...
        for dt in dates1:
            if str(dt.date()) in df_00.index:
                ...
                if prev_date != dummy_date:
                    ...
                    #print symbol,prev_date,prev_value,curr_date,curr_value,change_pct
                    rows_dailyreturns.append([symbol,curr_date,change_pct,curr_value])
                    #'{percent:.2%}'.format(percent=pdeltapct_to_sell_price)
                    #print symbol,curr_date,change_pct
...
#    def dailyreturns_notbackfilled(self,):
...
#        
#        import pullprices as pp
#        df_00 = pp.stockhistorynobackfilltodataframeusingcache(symbol,startdate_string,str(yesterday_date)) #,str(today_date))
#        #print list(df_00)#['Close','Adj Close']
#        #print df_00[['Close','Adj Close']]
#        
#        import pandas as pd
...
#        rows_dailyreturns = []        
#        #rows_optionpricescurrent.append(['optionsymbol','stockprice','strike','pdeltapct_to_sell_price','cumprob_to_sell_price','bid','ask','last'])
#        rows_dailyreturns.append(['a_symbol','b_monthend','e_pctchange','f_logreturn','d_end'])
#        
#        import math
#        for dt in dates1:
#            if str(dt.date()) in df_00.index:
...
#        
#        mydict = {}
#        mydict[0] = {'a_symbol':symbol,'b_monthend':str(today_date),'e_pctchange':curr_pctchange,'f_logreturn':curr_logreturn,'d_end':curr_price}
#        df_curr = pd.DataFrame(mydict).T
#        #print df_curr.T
#        
#        
#        df_dailyreturnstotoday = df_dailyreturnsfinite.append(df_curr, ignore_index=True)
#        #wwwww
#        df_dailyreturnstotoday.to_csv('c:\\Batches\\$Work\\returnstest.csv',columns=('a_symbol','b_monthend','e_pctchange','f_logreturn','d_end'))
#        
#        #print df_dailyreturns
#        #print str(today_date)[:7]
#        return df_dailyreturnstotoday
#
    ...
    def _annualizeddailyreturn(self,):
        ...
        firstdate = df_dailyreturns.loc[0]['b_monthend']
        #print firstdate
        lastdate = df_dailyreturns.loc[len(df_dailyreturns)-1]['b_monthend']
        #print lastdate
        #print df_dailyreturns
...
if __name__=='__main__':
    ...
    o = perform(symbol,startdate,'daily')
    print '------ DailyReturnsDataframe ------'
    print o.monthlyreturns()
    print 'annualizedreturn', o.annualizedreturn()

...
#        df_00 = pp.stockhistorybackfilledtodatframeofstockhistoryinstancesusingcache(symbol,startdate_string,str(yesterday_date)) #,str(today_date))
        ...
        rows_monthlyreturns.append(['a_symbol','b_periodend','e_pctchange','e_logreturn','d_end'])
...
#        return ar
    ...
    def _annualizedmonthlyreturnusinglogreturns(self,):
        ...
        #print lastdate
        #print df_monthlyreturns
        df_monthlyreturns.loc[df_monthlyreturns.index,'e_logreturnunitized']= df_monthlyreturns.loc[df_monthlyreturns.index, 'e_logreturn'] + float(1.0)
        ls_monthlyreturns = df_monthlyreturns['e_logreturnunitized'].values.tolist()

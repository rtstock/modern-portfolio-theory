...
class pull:
    ...
    def setclassdataframes(self,symbols,fromdate,todate):
        ...
        #print self.StockHistoryDataframe
        #stop
    ...
    def stockhistoryasdataframe(self,symbols,fromdate,todate):
        ...
        for c in chunks:
            i +=1
            if on == True:
                print 'pulling prices for chunk',i, '* 100 total of', len(c), 'symbol'
        ...
        if '$US' in symbols:
            ...
            df_append = df_missing.loc[df_missing['Ticker'] == '$US']
            df_append['Adj Close'] = 1.0
            df_append['Close'] = 1.0
            df_good = df_good.append(df_append)
            #print df_good
            #stop
            #df_good['$US'] = 1
            #print 'Yes -----------------------------------------'
...
##                            ]
    ...
    symbols = ['MAR', 'MON', 'NOV', 'A', 'AAL', 'AAP', 'AAPL','$US' ]

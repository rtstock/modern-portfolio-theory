...
#        
#        mydict = {}
#        mydict[0] = {'a_symbol':symbol,'b_periodend':str(today_date),'e_pctchange':curr_pctchange,'d_end':curr_price}
...
#        rows_dailyreturns = []        
#        #rows_optionpricescurrent.append(['optionsymbol','stockprice','strike','pdeltapct_to_sell_price','cumprob_to_sell_price','bid','ask','last'])
#        rows_dailyreturns.append(['a_symbol','b_periodend','e_pctchange','d_end'])
#        
#        
#        for dt in dates1:
#            if str(dt.date()) in df_00.index:
...
#        return df_dailyreturnstotoday
    ...
    def dailyreturns(self,):
        ...
        rows_dailyreturns = []        
        #rows_optionpricescurrent.append(['optionsymbol','stockprice','strike','pdeltapct_to_sell_price','cumprob_to_sell_price','bid','ask','last'])
        rows_dailyreturns.append(['a_symbol','b_periodend','e_pctchange','f_logreturn','d_end'])
        ...
        df_dailyreturnstotoday = df_dailyreturnsfinite.append(df_curr, ignore_index=True)
        #wwwww
        df_dailyreturnstotoday.to_csv('c:\\Batches\\$Work\\returnstest.csv',columns=('a_symbol','b_periodend','e_pctchange','f_logreturn','d_end'))
...
#        return annualizedreturn
    ...
    def _annualizeddailyreturnusinglogreturns(self,):
        ...
        #print lastdate
        #print df_dailyreturns
        df_dailyreturns.loc[df_dailyreturns.index,'f_logreturnunitized']= df_dailyreturns.loc[df_dailyreturns.index, 'f_logreturn'] + float(1.0)
        ls_dailyreturns = df_dailyreturns['f_logreturnunitized'].values.tolist()
        listmultiplied = reduce(lambda x, y: x*y, ls_dailyreturns)
        #print listmultiplied

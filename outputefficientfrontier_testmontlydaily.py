...
class output:
    ...
    def __init__(self,
        ...
        self._setup(list_of_symbols 
                     ,  startdate_string
                     ,  monthlyordaily,pctchangeorlogreturn
                     )
    ...
    def _setup(self,list_of_symbols 
        ...
        o = ef.perform(list_of_symbols,startdate_string,monthlyordaily,pctchangeorlogreturn) # '^GSPC','^OEX','^MID','^RUT','^DJI'
...
if __name__=='__main__':
    o = output(['WMT','NKE','T','JPM','^RUT'],'2005-12-31','daily') 

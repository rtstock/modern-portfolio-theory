...
class perform:
    ...
    def __init__(self
                ...
                self.Period = period
                self.Source = source
                o = pullreturns.perform(symbol,startdate,period,source)
                ...
                cachedfilepathname = mycachefolder + '\\procoutput returnsyahoo '+ symbol + ' ' + startdate + ' ' + enddate + '.csv'
                watchfolderpathname = config.mywatcherfolder + '\\procoutput returnsyahoo '+ symbol + ' ' + startdate + ' ' + enddate + '.csv'
...
if __name__=='__main__':
    ...
    o = perform(symbol,startdate,'daily','Yahoo')

...
def monthlyreturnsusingyahoosymbol(symbol,startdate_string='2004-12-31'):
    # Parameters
...
def annualizedreturns(symbol,startdate_string='2004-12-31'):
    #=PRODUCT(F85:F155)^(1/($B85/12))-1
    df_monthlyreturnsusingyahoosymbol = monthlyreturnsusingyahoosymbol(symbol,startdate_string)
    df_monthlyreturnsusingyahoosymbol = df_monthlyreturnsusingyahoosymbol.dropna()
    df_monthlyreturnsusingyahoosymbol['e_pctchangeunitized'] = df_monthlyreturnsusingyahoosymbol['e_pctchange'] + 1
...
def standarddeviationofmonthlyreturns(symbol,startdate_string='2004-12-31'):
    df_monthlyreturnsusingyahoosymbol = monthlyreturnsusingyahoosymbol(symbol,startdate_string)
    std_float = float(df_monthlyreturnsusingyahoosymbol['e_pctchange'].std())
    return std_float
    
if __name__=='__main__':
    std_float = standarddeviationofmonthlyreturns('^GSPC','2009-12-31')
    print std_float
    
#    n = annualizedreturns('^GSPC','2004-12-31')
#    print n
    print 'there was no method from library pullreturns chosen'
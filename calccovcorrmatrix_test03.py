...
class perform:
    ...
    def set_ListOfSymbols(self,ListOfSymbols):
        self._ListOfSymbols = ListOfSymbols
    def get_ListOfSymbols(self):
        return self._ListOfSymbols
    ListOfSymbols = property(get_ListOfSymbols, set_ListOfSymbols)
    ...
    def __init__(self,
        ...
        self.ListOfSymbols = list_of_symbols
        self.StartDateString = startdate_string
        self.DataFrameMonthlyReturns = self.monthlyreturns()
        #if showresults == 1:
...
#    DataFrameResult = property(get_DataFrameResult, set_DataFrameResult)   
    ...
    def monthlyreturns(self,
        ...
        mysymbolslist = self.ListOfSymbols # list_of_symbols #['^GSPC','^DJI','^MID','^OEX','AAPL','LEO']
        
        for symbol in mysymbolslist:
            df = pr.monthlyreturnsusingyahoosymbol(symbol,self.StartDateString)
...
#            else:
    ...
    def cov(self,
        ...
        df_align = self.DataFrameMonthlyReturns #monthlyreturns(list_of_symbols)
...
#        print '----------------------------------------------------'
        ...
        df_align = self.DataFrameMonthlyReturns #self.monthlyreturns(list_of_symbols)
        df_align = df_align.dropna()
...
if __name__=='__main__':
    o = perform(['^GSPC','^OEX','^MID','^RUT','^DJI','AAPL'],'2009-12-31')
    
    df = o.monthlyreturns()
    ser = o.seedweightseries()
    print df    
    print ser
    print 'there was no method from library mydata chosen'
...
class perform:
    def __init__(self):
        ...
        mydict = self._getdictionaryofsymbols()
        self.DictionaryOfWeights = mydict
        
        
    def set_DictionaryOfWeights(self,DictionaryOfWeights):
        self.set_DictionaryOfWeights = DictionaryOfWeights
    def get_DictionaryOfWeights(self):
        return self._DictionaryOfWeights
    DictionaryOfWeights = property(get_DictionaryOfWeights, set_DictionaryOfWeights)
    ...
    def CheckDate(self,DateString,DateFormat):
        import time
        date = DateString
        try:
    ...
    def _getdictionaryofsymbols(self,):
        # ==========
        # Parameters
